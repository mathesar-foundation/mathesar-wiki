...
1. Will there be DDL outside of columns operation, should attnum be leaked outside columns operations - No
...
- Views use column
- We could have a feature where the frontend could supply the alias of the column, this could solve the issue dom was talking about
- Put a pause on the PR. 
- Records operations should be the only DML. Answers question (1)
- Maybe we need a directory.
