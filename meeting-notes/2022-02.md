...
- **Naming Convention**
  ...
  - Mukesh wanted to have distinction between integration test and E2E, where playwright should be used for writing E2E test and integration test should be based on jsdom
  ...
  For time being, he agreed to have integration test written with UI automation using `playwright`.
