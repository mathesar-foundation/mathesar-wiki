...
## The Problem
We are building a visual query builder into Mathesar to help the user find answers to questions using their data and to create [Views](../../../archive/product/concepts/views.md). To make the visual query builder easy to use, we needed to make a bunch of assumptions that limits the types of queries that can be produced.
...
## Resources
- [Views "Concepts" page](../../../archive/product/concepts/views.md)
- ["Views in Mathesar" product spec](../../../archive/product/specs/2022-01-views/index.md)
