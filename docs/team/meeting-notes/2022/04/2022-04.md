...
- Team members should use completing all functionality in the [design specs](../../../../archive/product/design/specs/index.md) in the frontend as the success criteria for their goal unless otherwise explicitly decided
