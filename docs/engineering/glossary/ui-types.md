...
Please see the ["Data Types" product concept page](../../archive/product/concepts/data-types.md) for more information about the idea behind UI data types (a.k.a. "UI types" for brevity).
...
## Further Reading
- The [Global Data Type Components design spec](../../archive/product/design/specs/global-data-type-components.md) shows the user experience of UI Data Types and PostgreSQL types in the UI.
