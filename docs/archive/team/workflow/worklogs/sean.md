...
- Update ["New DB Connection" UI specs](/archive/product/design/specs/new-db-connection-form/)
...
- Call with Brent about DB connections UI
- Finish first draft of DB connection UI [specs](/archive/product/design/specs/new-db-connection-form/) and send an [email](https://groups.google.com/a/mathesar.org/g/mathesar-developers/c/fcRG1Yb3d68) requesting that others review it.
...
- Read Installation Improvements [project](/archive/product/projects/2023/08/installation-improvements-0_1_4/) and [plan](/archive/product/technical-specs/installation-improvements-plan-0_1_4/) to become more familiar with it for the release
...
- Minor [updates](https://github.com/centerofci/mathesar-wiki/commit/11b9cb8266b72d86718953eceb3ce44843e6c1ca) to [frontend fixes](/archive/product/projects/2023/07/2023-07-frontend-fixes) project description
...
- Re-review [Publicly Sharable Links spec](/archive/product/specs/publicly-shareable-links)
