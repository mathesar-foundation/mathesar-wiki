...
- Update ["New DB Connection" UI specs](../../../product/design/specs/new-db-connection-form.md)
...
- Whittle down queue of [all assigned tickets](https://github.com/orgs/centerofci/archive/projects/1/views/3?groupedBy%5BcolumnId%5D=Assignees) by closing, commenting, and unassigning people
...
- Document [repo setup tasks](https://github.com/centerofci/mathesar-internal-crm/issues/2) in [wiki page](../../../../engineering/how-tos/set-up-new-repo.md) and add section on removing a repo.
...
- Call with Brent about DB connections UI
- Finish first draft of DB connection UI [specs](../../../product/design/specs/new-db-connection-form.md) and send an [email](https://groups.google.com/a/mathesar.org/g/mathesar-developers/c/fcRG1Yb3d68) requesting that others review it.
...
- Read Installation Improvements [project](../../../product/projects/2023/08/installation-improvements-0_1_4.md) and [plan](../../../product/technical-specs/installation-improvements-plan-0_1_4.md) to become more familiar with it for the release
...
- Publish [Markdown Style Guide](../../../../engineering/markdown.md)
...
- Minor [updates](https://github.com/centerofci/mathesar-wiki/commit/11b9cb8266b72d86718953eceb3ce44843e6c1ca) to [frontend fixes](../../../product/projects/2023/07/2023-07-frontend-fixes.md) project description
...
- Add [2023-07 frontend fixes](https://github.com/centerofci/mathesar-wiki/blob/master/archive/product/projects/2023/07/2023-07-frontend-fixes.md) project page
...
- Re-review [Publicly Sharable Links spec](../../../product/specs/publicly-shareable-links.md)
