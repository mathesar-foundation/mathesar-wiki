...
If we end up having a column menu in [the Query Builder](./03-the-query-builder.md), we can probably reuse it here.
...
- **Allowed values**: List of pre-defined formulas, see [04. Formulas](./04-formulas.md)
...
Details about creating formulas are in [04. Formulas](./04-formulas.md).
