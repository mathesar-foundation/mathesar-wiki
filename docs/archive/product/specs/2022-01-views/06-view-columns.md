...
If we end up having a column menu in [the Query Builder](/archive/product/specs/2022-01-views/03-the-query-builder), we can probably reuse it here.
...
![screen_shot_2022-01-20_at_4.21.05_pm.png](/assets/archive/product/specs/2022-01-views/06-view-columns/screen_shot_2022-01-20_at_4.21.05_pm.png)

## Formula
This is the formula used to generate data in for this column.

- **Allowed values**: List of pre-defined formulas, see [04. Formulas](/archive/product/specs/2022-01-views/04-formulas)
...
![screen_shot_2022-01-20_at_4.23.21_pm.png](/assets/archive/product/specs/2022-01-views/06-view-columns/screen_shot_2022-01-20_at_4.23.21_pm.png)

Details about creating formulas are in [04. Formulas](/archive/product/specs/2022-01-views/04-formulas).
