...
A **table** is where data in a [Database](../../concepts/databases.md) is actually stored.

Tables consist of **columns** and **records** (rows).

- A **column** describes the data stored, including (but not limited to ) its [Data Type](../../concepts/data-types.md).
...
Although this is convenient for data entry, while looking at the data or analyzing it, you might want to see the full country name next to each person's name. For that functionality, you should set up a [View](../../concepts/views.md).