...
A **schema** is a workspace within a [Database](../../concepts/databases.md) that contains [Tables](../../concepts/tables.md), [Views](../../concepts/views.md), and other database objects.
