...
A **Filter** allows you to reduce the amount of data displayed in a [Table](../../concepts/tables.md) or a [View](../../concepts/views.md) based on specified criteria.
...
### Filters in Mathesar
You can filter data in a [Table](../../concepts/tables.md) or a [View](../../concepts/views.md) in Mathesar using either the "Filters" button or each column's menu.

## Further Reading
- If you're curious, you can look at our [engineering page about Filters](../../../../engineering/glossary/filters.md).
