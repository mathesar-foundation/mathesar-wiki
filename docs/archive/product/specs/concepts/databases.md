...
Within a database, you can store different kinds of data in different [Schemas](../../concepts/schemas.md). Data is stored in [Tables](../../concepts/tables.md) and can also be manipulated through [Views](../../concepts/views.md).

## Usage
- Mathesar will create a new database for users unless one is already provided.
- We encourage users to use [Schemas](../../concepts/schemas.md) for storing different sets of unrelated data rather than creating multiple databases.