...
- Users should have the features needed to manage a basic collaborative media inventory using Mathesar. We do not have a specific set of features, but keeping a simple use case in mind helps us cut features that may be too advanced.
  - Please see the following design documents for our initial exploration on this topic:
    - [Inventory Use Case exploratory document](./design/exploration/use-cases/inventory-use-case.md)
    - [Inventory: Data Exploration exploratory document](./design/exploration/inventory-data-exploration.md)
    - [Inventory Use Case report/conclusions](./design/reports/inventory-use-case.md)
...
- Also see our [Product Principles](../../product/index.md).
...
## Future Features
Please see [Feature Ideas](./feature-ideas.md) for a long and disorganized list of feature ideas that we're drawing from to create this roadmap.
