...
| Date       | Outcome                                                                                                                                                                                                                                                          |
|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2023-04-10 | Work starts, we start with the code changes and then move to documentation.                                                                                                                                                                                      | 
...
| 2023-04-17 | Feedback + Testing(both done by the testing team) for **documentation** PRs me by the review team starts in parallel. This ensures the documentation can be understood and works with various scenarios and user segments(technical users, less technical users) |
