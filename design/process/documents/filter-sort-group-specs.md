...
![](https://hackmd.io/_uploads/S1uJu5A5_.png)
...
![](https://i.imgur.com/tzQmsIT.png =200x)
...
![](https://hackmd.io/_uploads/r1Q7VsCcd.png)
...
![](https://hackmd.io/_uploads/Hk8Kt0Nsd.png =360x)
...
#### States
##### Open
![](https://hackmd.io/_uploads/rJYKrdyou.png =240x)


##### Closed
![](https://hackmd.io/_uploads/SkfardkoO.png)
...
![](https://hackmd.io/_uploads/Bk59qfRcu.png =240x)
...
![](https://hackmd.io/_uploads/HyaqfcVod.png =320x)
...
![](https://hackmd.io/_uploads/S1y7ZXC9O.png =240x)

Changing the column can be done by selecting any of the options from the dropdown menu.

![](https://hackmd.io/_uploads/S1U7zXRcu.png =240x)

![](https://hackmd.io/_uploads/rJioPmRc_.png =240x)
...
![](https://hackmd.io/_uploads/rkY-Lnrou.png =200x)

Users can add additional filters by clicking on the "Add Filter" option.

![](https://hackmd.io/_uploads/SkSMQkrod.png =340x)
...
![](https://hackmd.io/_uploads/HyTm5Q0qd.png =240x)

Users can access the available options by clicking on the button. 

![](https://hackmd.io/_uploads/B1S_G4Rc_.png =370x)

The button will reflect the current column status.

![](https://hackmd.io/_uploads/SknEcm09O.png =210x)
...
![](https://hackmd.io/_uploads/HkowXkBj_.png =360x)
...
![](https://hackmd.io/_uploads/S1s58409d.png)

#### Sorted Table
When a table is sorted, the table header provides a visual indicator. 

![](https://hackmd.io/_uploads/BkaxwEC5O.png)
...
![](https://hackmd.io/_uploads/ByO-PVR9_.png)
