...
Please, note that GSoC has a limited amount of projects that are able be funded. Therefore, we will not be able to select a mentee for every project idea that we have listed. Our organization will be allocated a limited number of project slots by the program and we can only accept the number of mentees that we have slots for.